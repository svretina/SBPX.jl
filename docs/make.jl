...
DocMeta.setdocmeta!(SBPX, :DocTestSetup, :(using SBPX); recursive = true)
...
makedocs(;
    modules = [SBPX],
    authors = "Stamatis Vretinaris <svretina@gmail.com>",
    repo = "https://github.com/svretina/SBPX.jl/blob/{commit}{path}#{line}",
    sitename = "SBPX.jl",
    format = Documenter.HTML(; canonical = "https://svretina.github.io/SBPX.jl"),
    pages = list_pages(),
)

deploydocs(; repo = "github.com/svretina/SBPX.jl")
