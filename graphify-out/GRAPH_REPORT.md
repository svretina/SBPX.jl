...
## Summary
- 35 nodes · 61 edges · 8 communities detected
...
Cohesion: 0.4
Nodes (5): InteractiveUtils, _boundary_relative_offsets(), _format_boundary_rows(), SBPX, SphericalSBPOperators

### Community 3 - "Community 3"
Cohesion: 0.5
Nodes (4): _derivative_operator_info(), _instantiate_source(), _periodic_coefficients(), _resolve_source()
...
- **Why does `SBPX` connect `Community 2` to `Community 0`, `Community 3`, `Community 4`, `Community 5`, `Community 6`?**
  _High betweenness centrality (0.450) - this node is a cross-community bridge._
- **Why does `_derivative_operator_info()` connect `Community 3` to `Community 0`, `Community 2`, `Community 6`?**
